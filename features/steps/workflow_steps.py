...
def get_driver():
    """
    Returns a WebDriver instance based on the specified browser in environment variables.
    Supports 'chrome' and 'firefox'. Defaults to 'chrome'.
    """
...
def before_all(context):
    ...
    """
    context.browser = os.getenv("BROWSER", "chrome")  # Default browser
